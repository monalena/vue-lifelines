...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            drawSquare(svg, x, y) {
                let g = svg.append('g');
                g.attr('transform','translate('+x+','+y+') scale(0.008 0.008) ');
                let p = g.append('path');
                p.attr('fill', '#000000');
                ...
                data.forEach((lifeline) => {
                    ...
                    lifeline["events"].forEach( (d) => {
                        ...
                        if (d.Source === "Transportation Crime and Trial Records V1") {
                            ...
                            symX = x(d.dates);
                            const p = this.labelCoords(facePath, symX, 6);
                            // symY = y(d.yValue) - 12;
                            ...
                            symX = x(d.dates);
                            const p = this.labelCoords(facePath, symX, 2);
